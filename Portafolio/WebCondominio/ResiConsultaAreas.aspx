<%@ Page Title="" Language="C#" MasterPageFile="~/SiteResidente.Master" AutoEventWireup="true" CodeBehind="ResiConsultaAreas.aspx.cs" Inherits="WebCondominio.ResiConsultaAreas" %>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	       ...
	       <ul class="nav menu">
                ...
                <li><a href="ResiContacto.aspx"><span class="glyphicon glyphicon-comment"></span> Contacto</a></li>
                 ...
                 <li class="parent active"><a href="ResiConsultaAreas.aspx"><span class="glyphicon glyphicon-tree-deciduous"></span> Areas Disponibles</a></li>
