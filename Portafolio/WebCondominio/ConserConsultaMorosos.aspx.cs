...
{
    public partial class ConserConsultaMorosos : System.Web.UI.Page
    {
        ...
        private void CargasPagosGastos()
        {
            ...
            if (gastos.PagosGastosCountPendientes() != 0)
            {
                gvusuarioad.DataSource = gastos.PagosGastosPendientes();
