<%@ Page Title="" Language="C#" MasterPageFile="~/SiteResidente.Master" AutoEventWireup="true" CodeBehind="ResiConsultarMultas.aspx.cs" Inherits="WebCondominio.ResiConsultarMultas" %>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	       ...
	       <ul class="nav menu">
		        ...
		        <li class="parent active"><a href="ResiConsultarMultas.aspx"><span class="glyphicon glyphicon-ban-circle"></span> Multas</a></li>
