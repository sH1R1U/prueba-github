...
{
    public partial class ResiConsultarMultas : System.Web.UI.Page
    {
        ...
        private void CargasMultas()
        {
            try
            {
                ...
                multa.NombreUser = (string)Session["NombreUser"];
                if (multa.MultasCountporResidente() != 0)
                {
                    gvMultas.DataSource = multa.MultasporResidentes();
                    gvMultas.DataBind();
                    visible();
