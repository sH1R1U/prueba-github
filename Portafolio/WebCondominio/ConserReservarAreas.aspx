<%@ Page Title="" Language="C#" MasterPageFile="~/SiteConseje.Master" AutoEventWireup="true" CodeBehind="ConserReservarAreas.aspx.cs" Inherits="WebCondominio.ConserReservarAreas" %>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	       ...
	       <ul class="nav menu">
                ...
                <li class="parent active"> <a href="ConserReservarAreas.aspx"><span class="glyphicon glyphicon-floppy-disk"></span> Reserva Areas</a></li>
