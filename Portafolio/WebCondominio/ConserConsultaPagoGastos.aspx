<%@ Page Title="" Language="C#" MasterPageFile="~/SiteConseje.Master" AutoEventWireup="true" CodeBehind="ConserConsultaPagoGastos.aspx.cs" Inherits="WebCondominio.ConserConsultaPagoGastos" %>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	       ...
	       <ul class="nav menu">
		        ...
		        <li class="parent active"><a href="ConserConsultaPagoGastos.aspx"><span class="glyphicon glyphicon-briefcase"></span> Gastos Comunes</a></li>
