<%@ Page Title="" Language="C#" MasterPageFile="~/SiteConseje.Master" AutoEventWireup="true" CodeBehind="ConserConsultaPagoMultas.aspx.cs" Inherits="WebCondominio.ConserConsultaPagoMultas" %>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	       ...
	       <ul class="nav menu">
		        ...
		        <li class="parent active"><a href="ConserConsultaPagoMultas.aspx"><span class="glyphicon glyphicon-ban-circle"></span> Pago Multas</a></li>
                    ...
                    <div class="panel-body">
						<div class="canvas-wrapper">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="EstadoPago" HeaderText="EstadoPago" 
