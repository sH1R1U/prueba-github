<%@ Page Title="" Language="C#" MasterPageFile="~/SiteResidente.Master" AutoEventWireup="true"
    CodeBehind="ResiPagarGasto.aspx.cs" Inherits="WebCondominio.ResiPagarGasto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="parent active"><a href="ResiPagarGasto.aspx"><span class="glyphicon glyphicon-usd">
            </span>Pago Gasto Comun</a></li>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                <asp:DropDownList ID="ddlMes" runat="server" class="form-control" AutoPostBack="True"
                            ...
                            <div class="col-xs-4">
                                <asp:DropDownList ID="ddlGasto" runat="server" class="form-control">
                                </asp:DropDownList>
                            </div>
                            <div class="col-xs-2">
                    ...
                    <div class="panel-body">
                        <div class="canvas-wrapper">
                            <b>
                                <asp:GridView ID="gvusuarioad" runat="server" CssClass="table table-striped table-bordered table-hover"
                                    AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:BoundField DataField="Id" HeaderText="Id" SortExpression="Id" />
                                        <asp:BoundField DataField="FechaGasto" HeaderText="FechaGasto" SortExpression="FechaGasto" />
                                        <asp:BoundField DataField="NombreGastoComun" HeaderText="NombreGastoComun" SortExpression="NombreGastoComun">
                                        </asp:BoundField>
                                        <asp:BoundField DataField="ValorGasto" HeaderText="ValorGasto" SortExpression="ValorGasto" />
                                    </Columns>
                                </asp:GridView>
                            </b>
                    ...
                    <div class="panel-body">
                        <div class="canvas-wrapper">
                            <b>
                                <asp:GridView ID="gvMultas" runat="server" CssClass="table table-striped table-bordered table-hover"
                                    AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:BoundField DataField="Id" HeaderText="Id" SortExpression="Id" />
                                        <asp:BoundField DataField="FechaMulta" HeaderText="FechaMulta" SortExpression="FechaMulta" />
                                        <asp:BoundField DataField="DetalleMulta" HeaderText="DetalleMulta" SortExpression="DetalleMulta">
                                        </asp:BoundField>
                                        <asp:BoundField DataField="ValorMulta" HeaderText="ValorMulta" SortExpression="ValorMulta" />
                                    </Columns>
                                </asp:GridView>
                            </b>
                    ...
                    <div class="panel-body">
                        <div class="canvas-wrapper">
                            <asp:GridView ID="gvusuario" runat="server" CssClass="table table-striped table-bordered table-hover"
                                AutoGenerateColumns="False">
                                <Columns>
                                    <asp:BoundField DataField="Id" HeaderText="Id" SortExpression="Id" />
                                    <asp:BoundField DataField="vivienda" HeaderText="Vivienda" SortExpression="vivienda" />
                                    <asp:BoundField DataField="usuario" HeaderText="Usuario" SortExpression="usuario"
                                        ItemStyle-CssClass="hidden-xs" HeaderStyle-CssClass="hidden-xs" />
                                    <asp:BoundField DataField="FechaGasto" HeaderText="Mes Gasto Comun" SortExpression="FechaGasto"
                                    ...
                                    <asp:BoundField DataField="FechaPago" HeaderText="Fecha Pago" SortExpression="FechaPago"
                                        DataFormatString="{0:d}" ItemStyle-CssClass="hidden-xs" HeaderStyle-CssClass="hidden-xs" />
                                </Columns>
                            </asp:GridView>
                            <center><asp:Label ID="lblPagoGasto" runat="server" Text=""></asp:Label></center>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="canvas-wrapper">
                            <center><asp:Button
                                      ID="btnPagarGasto" CssClass="btn-primary form-control" 
                                      visible="false" runat="server" Text="Pagar Gasto Comun" 
                                       /></center>
