<%@ Page Title="" Language="C#" MasterPageFile="~/SiteConseje.Master" AutoEventWireup="true" CodeBehind="ConserConsultaAreas.aspx.cs" Inherits="WebCondominio.ConserConsultaAreas" %>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	       ...
	       <ul class="nav menu">
                ...
                <li class="parent active"><a href="ConserConsultaAreas.aspx"><span class="glyphicon glyphicon-ban-circle"></span> Areas Comunes</a></li>
